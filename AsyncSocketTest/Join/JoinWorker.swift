...
class JoinWorker: NSObject {
    ...
    func startBrowsing(netServiceBlock:  @escaping (String) -> Void, netServiceBrowserBlock: @escaping (String) -> Void, socketStatusBlock: @escaping (String, GCDAsyncSocket) -> Void, reloadConnectionsBlock: @escaping ([NetService]) -> Void, incominngValueBlock:
        ...
        self.serviceBrowser.searchForServices(ofType: Network.NETSERVICE.type, inDomain: Network.NETSERVICE.domain)
    }
...
extension JoinWorker: NetServiceBrowserDelegate {
...
extension JoinWorker: NetServiceDelegate {
...
extension JoinWorker: GCDAsyncSocketDelegate {
    ...
    func socket(_ sock: GCDAsyncSocket, didConnectToHost host: String, port: UInt16) {
      ...
      //  socket = sock
        ...
        sendValue(str: Network.NETSERVICE.joinSoc)
    }
